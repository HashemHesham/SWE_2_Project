<?php
    ...
    Route::prefix('admin/manage')->group(function() {
        Route::prefix('users')->group(function() {
            ...
            Route::post('/change-password', 'UserController@changePassword')->name('admin.users.changePassword');
            ...
            Route::get('/user-profile/{id}', 'UserController@showProfile')->name('admin.users.showProfile');
        });
    });